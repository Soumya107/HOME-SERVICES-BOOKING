...
<body>
	<div class="video-w3l" data-vide-bg="video/1">
			...
			<div class="sub-main-w3">
				...
				<form method="post" action="logcheck.php">
					<div class="pom-agile">
						...
						<input placeholder="Enter your Email Id" name="username" class="user" type="text" required="">
					</div>
					<div class="pom-agile">
					...
					<div class="sub-w3l">
					<a href="reg_form.php">New User? Register Here</a>
						<div class="clear"></div>
		...
		<!--footer-->
		<div class="footer"> 
			<p>&copy; 2022 Home Services. All rights reserved | Design & developed by
				<a href="#"></a>
			</p>
		</div>
		<!--//footer-->
