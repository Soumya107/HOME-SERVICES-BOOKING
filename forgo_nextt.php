...
$mail->setFrom('vtechprojectmail@gmail.com', 'Home Services');
 $mail->addAddress($email_id, 'Home Services');     // Add a recipient
...
$mail->Body    = '<div style="background-color:#FFFF00; font-size:30px;" align="center">Username : '.$use_rname.'<br><b style="font-size:30px; "> Password :'. $password .'</b></div>';
